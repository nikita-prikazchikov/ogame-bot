...
public abstract class PageObject {
    ...
    public boolean onPage(String url){
        return webDriver.getCurrentUrl().contains(url);
    }

    //==================================    Actions on  elements section   ==================================
    ...
    protected WebElement getElement(By bySelector) {
        return this.getElement(webDriver, bySelector);
    }
    ...
    protected WebElement findElement(By bySelector) {
        return this.findElement(webDriver, bySelector);
    }
    ...
    protected List<WebElement> findElements(By bySelector) {
        return this.findElements(webDriver, bySelector);
    }
    ...
    protected boolean isElementExists(By bySelector) {
        return this.isElementExists(webDriver, bySelector);
    }
    ...
    protected boolean isElementDisplayed(By bySelector) {
        return isElementDisplayed(webDriver, bySelector);
    }
    ...
    protected void scrollPage(int value) {
        try {
            ...
            jse.executeScript(String.format("window.scrollBy(0, %s)", value));
    ...
    protected WebElement waitForWebElement(final SearchContext parent, final By bySelector) {
        WebElement element;
        try {
            final PageObject that = this;
            element = (new WebDriverWait(webDriver, DriverManager.getImplicitlyWait()))
    ...
    protected WebElement waitForWebElement(final By bySelector) {
        return this.waitForWebElement(webDriver, bySelector);
    }
    ...
    protected boolean waitForWebElementNotExist(final SearchContext parent, final By bySelector, Integer timeout) {
        ...
        try {
            final PageObject that = this;
            ContextHolder.getDriverManager().resetImplicitlyWait();
            result = (new WebDriverWait(webDriver, timeout))
    ...
    protected boolean waitForWebElementNotExist(final By bySelector, Integer timeout) {
        return waitForWebElementNotExist(webDriver, bySelector, timeout);
    }

    protected boolean waitForWebElementNotExist(final By bySelector) {
        return this.waitForWebElementNotExist(webDriver, bySelector, DriverManager.getImplicitlyWait());
    }
    ...
    protected Boolean waitForWebElementIsDisplayed(final By bySelector, Integer timeout) {
        return waitForWebElementIsDisplayed(webDriver, bySelector, timeout);
    }

    protected Boolean waitForWebElementIsDisplayed(final By bySelector) {
        return this.waitForWebElementIsDisplayed(webDriver, bySelector, DriverManager.getImplicitlyWait());
    }
    ...
    protected Boolean waitForWebElementNotDisplayed(final By bySelector, Integer timeout) {
        return waitForWebElementNotDisplayed(webDriver, bySelector, timeout);
    }

    protected Boolean waitForWebElementNotDisplayed(final By bySelector) {
        return this.waitForWebElementNotDisplayed(webDriver, bySelector, DriverManager.getImplicitlyWait());
    }
    ...
    protected Boolean waitForWebElementStopMoving(final WebElement element) {
        ...
        try {
            final PageObject that = this;
            result = (new WebDriverWait(webDriver, DriverManager.getImplicitlyWait()))
                    .until(d -> {
